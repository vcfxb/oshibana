...
pub static SCRYFALL_SCHEMA: LazyLock<Schema> = LazyLock::new(|| {
    ...
    let image_uris_field = field("image_uris", DataType::Struct(vec![
    ...
    Schema::from_iter(vec![
        ...
        field("related_cards", DataType::List(
        ...
        field("card_faces", DataType::List(
            Box::new(DataType::Struct(vec![
        ...
        field("legalities", DataType::Struct(vec![
        ...
        field("prices", DataType::Struct(vec![
        ...
        field("purchase_uris", DataType::Struct(vec![
        ...
        field("related_uris", DataType::Struct(vec![
