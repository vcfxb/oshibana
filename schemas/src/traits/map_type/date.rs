...
use polars::prelude::{ChunkedBuilder, DateChunked, DateType, Int32Type, PlSmallStr, PrimitiveChunkedBuilder};
...
impl PolarsBuilder<NaiveDate> for PrimitiveChunkedBuilder<Int32Type> {
    ...
    fn append(&mut self, val: NaiveDate) -> PolarsResult<()> {
        ...
        self.append_value(val.num_days_from_ce() - DateTime::UNIX_EPOCH.date_naive().num_days_from_ce());
        Ok(())
    }
